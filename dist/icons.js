...
System.register([], function (_export, _context) {
  ...
  var ICONS_TREND_UP, ICONS_TREND_DOWN, ICONS_TREND_NONE;
  return {
    setters: [],
    execute: function () {
      _export('ICONS_TREND_UP', ICONS_TREND_UP = [{
        text: 'Arrow Up',
        value: 'fa-arrow-up'
      }, {
        text: 'Arrow Long Up',
        ...
        text: 'Thumbs Up Filled',
        value: 'fa-thumbs-up'
      }]);

      _export('ICONS_TREND_UP', ICONS_TREND_UP);

      _export('ICONS_TREND_DOWN', ICONS_TREND_DOWN = [{
        text: 'Arrow Down',
        value: 'fa-arrow-down'
      }, {
        text: 'Arrow Long Down',
        value: 'fa-long-arrow-down'
      }, {
        text: 'Arrow Circle Down',
        value: 'fa-arrow-circle-o-down'
      }, {
        text: 'Arrow Circle Down Filled',
        ...
        text: 'Thumbs Down Filled',
        value: 'fa-thumbs-down'
      }]);

      _export('ICONS_TREND_DOWN', ICONS_TREND_DOWN);

      _export('ICONS_TREND_NONE', ICONS_TREND_NONE = [{
        text: 'Empty',
        value: 'fa-fw'
      }, {
        text: 'Check',
